  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">{t('emissionsTitle')}</h1>
        
        {/* Overview Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6">
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">{t('totalEmissions')}</h2>
            <p className="text-3xl font-bold text-gray-800 dark:text-gray-200">{emissions.total.toLocaleString()} {t('tonsUnit')}</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t('annualCO2emissions')}</p>
          </div>
          
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6">
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">{t('surrendered')}</h2>
            <p className="text-3xl font-bold text-green-600 dark:text-green-400">{emissions.surrendered.toLocaleString()} {t('tonsUnit')}</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6">
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">{t('remaining')}</h2>
            <p className="text-3xl font-bold text-red-600 dark:text-red-400">{emissions.remaining.toLocaleString()} {t('tonsUnit')}</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6">
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">{t('emissionsOverview')}</h2>
            <div className="h-64">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6">
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">{t('complianceStatus')}</h2>
            
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t('currentPeriod')}</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">{t('currentPeriodDates')}</p>
              </div>
              
              <div>
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t('complianceDeadline')}</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">{t('deadlineDate')}</p>
              </div>
              
              <div>
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t('complianceStatus')}</h3>
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{t('complianceSummary')}</h3>
                <div className="bg-gray-50 dark:bg-gray-700/50 rounded p-3">
                  <div className="flex justify-between mb-1">
                    <span className="text-sm text-gray-600 dark:text-gray-400">{t('totalEmissions')}:</span>
                    <span className="text-sm font-medium text-gray-800 dark:text-gray-200">{emissions.total.toLocaleString()} {t('tonsUnit')}</span>
                  </div>
                  <div className="flex justify-between mb-1">
                    <span className="text-sm text-gray-600 dark:text-gray-400">{t('surrendered')}:</span>
                    <span className="text-sm font-medium text-green-600 dark:text-green-400">{emissions.surrendered.toLocaleString()} {t('tonsUnit')}</span>
                  </div>
                  <div className="flex justify-between pt-1 border-t border-gray-200 dark:border-gray-600">
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('shortfall')}</span>
                    <span className="text-sm font-medium text-red-600 dark:text-red-400">{emissions.remaining.toLocaleString()} {t('tonsUnit')}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 overflow-hidden">
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t('availableCertificatesForSurrender')}</h2>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900/50 p-6 mt-8">
          <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">{t('aboutEUETSCompliance')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-md font-medium text-gray-800 dark:text-gray-200 mb-2">{t('complianceProcess')}</h3>
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded p-3 border border-gray-200 dark:border-gray-600">
                <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t('keyComplianceDates')}</h4>
            ...
            <div>
              <h3 className="text-md font-medium text-gray-800 dark:text-gray-200 mb-2">{t('penaltiesForNonCompliance')}</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                {t('penaltiesDesc')}
              </p>
              <div className="bg-red-50 dark:bg-red-900/20 rounded p-3 border border-red-200 dark:border-red-800">
                <h4 className="text-sm font-medium text-red-700 dark:text-red-400 mb-1">{t('nonComplianceConsequences')}</h4>
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 dark:bg-gray-900 dark:bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6 shadow-xl">
            {surrenderStatus === 'idle' && (
              <>
                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">{t('surrenderCertificate')}</h3>
                <div className="mb-4">
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            ...
            {surrenderStatus === 'loading' && (
              <div className="text-center py-4">
                <svg className="animate-spin h-10 w-10 text-green-600 dark:text-green-400 mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
